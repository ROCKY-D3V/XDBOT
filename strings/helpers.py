...
» /del: ᴅᴇʟᴇᴛᴇs ᴛʜᴇ ᴍᴇssᴀɢᴇ you ʀᴇᴘʟɪᴇᴅ ᴛᴏ
...
❍ /approve: ᴀᴘᴘʀᴏᴠᴇ ᴏғ ᴀ ᴜsᴇʀ. ʟᴏᴄᴋs, ʙʟᴀᴄᴋʟɪsᴛs, ᴀɴᴅ ᴀɴᴛɪғᴏᴏᴅ ᴡᴏɴ'ᴛ ᴀᴘᴘʟʏ ᴛᴏ ᴛʜᴇᴍ ᴀɴʏᴍᴏʀᴇ.
...
❍ /unapproveall: ᴜɴᴀᴘᴘʀᴏᴠᴇ ALL ɪɴ ᴀ ᴄʜᴀᴛ. ᴛʜɪs cannot ʙᴇ ᴜɴᴅᴏɴᴇ."""
...
❍ /kick : ᴋɪᴄᴋs ᴀ ᴜsᴇʀ ᴏᴜᴛ ᴏғ ᴛʜᴇ ɢʀᴏᴜᴘ, (ᴠɪᴀ ʜᴀɴᴅʟᴇ, ᴏʀ ʀᴇᴘʟʏ)"""
...
**<u>» ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs ꜰᴏʀ Cʜᴀᴛʙᴏᴛ :</u>**
